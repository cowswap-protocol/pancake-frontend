...
export const getAprData = (pool: Pot, performanceFee: number) => {
...
export const getPoolBlockInfo = (pool: Pot, currentBlock: number) => {
  const { isFinished } = pool
  const startBlock = 9002488
  const endBlock = 9102488
